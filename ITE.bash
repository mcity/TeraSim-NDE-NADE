...
experiment_name = "ITE_test" + "_" + time.strftime("%Y%m%d-%H%M%S")
...
for i in {1..1000}; do
    ...
    # test record
    python3 safetest_mcity_cosim_main.py --dir ${DIR_NAME} --mode ${experiment_name} --nth ${i} > ${DIR_NAME}/${experiment_name}/raw_data/${i}/res.txt
done
