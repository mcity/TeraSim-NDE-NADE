...
from SumoTrajVis import Utils
from SumoTrajVis import Additionals as _Addls
...
class Net:
    ...
    def generate_obj_text(self, style=None, stripe_width_scale=1, terrain_distance=0, terrain_z=0, terrain_hi_q=False,
        ...
        :param material_mapping: a dictionary mapping SumoTrajVis-generated material names to user-defined ones
    ...
    def plot(self, ax=None, clip_to_limits=False, zoom_to_extents=True, style=None, stripe_width_scale=1,
        ...
        :return: SumoTrajVis.ArtistCollection object containing all generated artists
        :type ax: plt.Axes
