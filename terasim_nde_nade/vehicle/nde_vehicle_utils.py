...
intersection_cutin_prob = (
    1.118159657654468e-04 * 0.5 * 2 * 1.2 * 1.5 * 1.25 * 0.5 * 0.5 * 2 * 0.7 * 0.5 * 1.5
)
intersection_neglect_conflict_lead_prob = (
    6.677231589776039e-04 * 3.86 * 1 * 0.7 * 1.2 * 1.25 * 1.56 * 2 * 0.5 * 1.5 * 2 * 0.9
)
...
intersection_tfl_prob = (
    0.058291608034515015 * 0.5 * 0.5 * 0.5 * 1.5 * 0.9 * 1.7 * 2 * 1.5 * 0.8 * 0.8
)
...
highway_rearend_prob = (
    3.47e-2 * 5 * 5 * 0.8 * 0.8 * 1.1 * 1.2 * 1.25 * 0.85 * 0.5 * 0.5 * 1.5 * 0.8 * 1.2
)
