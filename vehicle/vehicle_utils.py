...
def get_collision_type_and_prob(observation, negligence_mode, location_region, neg_location_region):
    ...
    highway_cutin_prob = 7.2e-8 * 0.952 * 0.91 * 1.5 * 0.67 # some sideswipe, some angle
    highway_rearend_prob = 8.4e-5 * 0.748 * 0.46 * 1.5 * 1.3 * 1.5 * 0.71

    roundabout_rearend_prob = 3.6e-8 * 0.952 * 0.86 * 0.98
    roundabout_neglect_conflict_lead_prob = 3.6e-7 * 0.5 * 2.27 * 1.5 # ignore conflict
    roundabout_cutin_prob = 8.4e-8 * 1.121 * 0.91 * 1.2 # mostly sideswipe

    intersection_rearend_prob = 6e-7 * 0.85 * 1.14 * 0.888 * 1.05
    intersection_cutin_prob = 1.2e-5 * 0.804 * 1.31 * 0.888 * 1.05 # mostly sideswipe
    intersection_neglect_conflict_lead_prob = 1.2e-6 * 0.5 * 0.1 * 0.888 * 1.05 # ignore conflict
    intersection_tfl_prob = 1.2e-5 * 1.026 * 2.02 * 0.888 * 1.05 # ignore traffic light
    intersection_headon_prob = 1.2e-7 * 1.388 * 0.888 * 1.05 # head on
