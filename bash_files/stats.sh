...
DIR_NAME="/scratch/henryliu_root/henryliu98/hyfrankl/mtlsp_output"
mode="nde-check"
...
grep -oP '(?<=lane=\")[^,]*(?<=\")' /scratch/henryliu_root/henryliu98/hyfrankl/mtlsp_output/ite-new/*/collision.xml | awk -F "[:\"/ ]" '{print $8, $10, $11}' | sort > record.txt
