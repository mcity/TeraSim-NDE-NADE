...
export IS_MAGNITUDE_ROUNDABOUT=10
export IS_MAGNITUDE_HIGHWAY=10
...
experiment_name="NADE_IS_I_${IS_MAGNITUDE_INTERSECTION}_R_${IS_MAGNITUDE_ROUNDABOUT}_H_${IS_MAGNITUDE_HIGHWAY}_P_${AVOID_COLLISION_IS_PROB}_60s_donot_use_trajectory_but_acceleration_v4"
