...
def get_collision_type_and_prob(observation, negligence_mode, location_region, neg_location_region):
    ...
    roundabout_fail_to_yield_prob = 1e-7
    ...
    highway_cutin_prob = 9.887380418491011e-05 * 0.232 * 1.65 * 1.23 * 0.36
    highway_rearend_prob = 1.0327637301820217e-04 * 3.64 * 1.21 * 1.63
