...
def get_collision_type_and_prob(observation, negligence_mode, location_region, neg_location_region):
    ...
    highway_rearend_prob = 2.01973828080024e-05

    roundabout_rearend_prob = 2.618321339245248e-07
    roundabout_neglect_conflict_lead_prob = 1.7341882919999998e-06
    roundabout_cutin_prob = 9.649855682301743e-07 # mostly sideswipe

    intersection_rearend_prob = 1.1112486308481602e-08
    intersection_cutin_prob = 7.1021242665959045e-08 # mostly sideswipe
    intersection_neglect_conflict_lead_prob = 9.134221635e-09
    intersection_tfl_prob = 2.109120984866411e-07
    intersection_headon_prob = 2.848759032444272e-08
