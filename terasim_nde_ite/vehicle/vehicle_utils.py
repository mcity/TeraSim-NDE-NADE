...
def get_collision_type_and_prob(observation, negligence_mode, location_region, neg_location_region):
    ...
    intersection_cutin_prob = 1.0648925125333899e-04 * 0.10 * 0.61 * 1.5 * 2.9 * 0.5
    intersection_neglect_conflict_lead_prob = 5.5069126130818786e-05 * 2.67 * 0.61 * 1.39
    intersection_rearend_prob = 1.0149373787617288e-06 * 2.78 * 0.44 * 0.29 * 0.62
    intersection_tfl_prob = 8.797353696327892e-04 * 0.37 * 0.13 * 2.67 * 0.75 * 1.17
    intersection_headon_prob = 1.0113094565177164e-06 * 4.71 * 0.1 * 2.57 * 0.25 * 0.5

    roundabout_fail_to_yield_prob = 1e-7 * 10
    roundabout_cutin_prob = 4.570171651138106e-05 * 0.35 * 0.6 * 0.5
    roundabout_neglect_conflict_lead_prob = 2.3721857594970477e-05 * 0.1 * 0.33 * 0.2 * 2
    roundabout_rearend_prob = 4.884970702773788e-07 * 0.2 * 5 * 0.5
    
    highway_cutin_prob = 9.887380418491011e-05 * 0.232 * 1.65 * 1.23 * 0.36 * 2
    highway_rearend_prob = 1.0327637301820217e-04 * 3.64 * 1.21 * 1.63 * 2
